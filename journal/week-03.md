...
_2026-08-19 · logged 2026-08-21 16:51 UTC_

- **Taught:** Data life cycle

**What I now understand**

The sequence of stages that data undergoes from collection to storage and archiving. This is important to ensure the quality and accuracy of the data, which helps support policing decision-makers

- **Still unclear:** Not applicable, the lecture was well delivered
...
- **Taught:** Understanding data for analysis

**What I now understand**

Every data tells a story, data analytics is classified into identify, dimension, measure and date/time
...
- **Taught:** analytical workflow

**What I now understand**

Every problem follows a pattern that is referred to as an analytical workflow. it has a nine-step analytical loop. This includes ask, find, access, clean, analyse, visualise, communicate, decision and feedback
